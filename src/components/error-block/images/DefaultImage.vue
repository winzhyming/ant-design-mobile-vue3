    ...
    <g fill="none" fill-rule="evenodd">
      ...
      <g transform="rotate(-90 102.429 55.357)">
        ...
        <mask id="error-block-image-default-c" fill="#fff">
          <use xlink:href="#error-block-image-default-b" />
        </mask>
        <use fill="#377EFF" xlink:href="#error-block-image-default-b" />
        <path
      ...
      <g transform="translate(132.857 124)">
        <mask id="error-block-image-default-e" fill="#fff">
          <use xlink:href="#error-block-image-default-d" />
        </mask>
        <use fill="#FBBE47" fill-rule="nonzero" xlink:href="#error-block-image-default-d" />
        <circle
          fill="#FFCD6B"
          fill-rule="nonzero"
