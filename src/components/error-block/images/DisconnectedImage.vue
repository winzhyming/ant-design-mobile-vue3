<template>
  ...
  >
    ...
    <defs>
      ...
      <circle id="error-block-image-disconnected-d" :cx="22.309" :cy="22.309" :r="22.309" />
      <path id="error-block-image-disconnected-a" d="M0 0h400v400H0z" />
    </defs>
    <g fill="none" fill-rule="evenodd">
      <mask id="error-block-image-disconnected-b" fill="#fff">
        <use xlink:href="#error-block-image-disconnected-a" />
      </mask>
      <g
      ...
      <g mask="url(#error-block-image-disconnected-b)">
        <g transform="translate(275.143 302.571)">
          <mask id="error-block-image-disconnected-e" fill="#fff">
            <use xlink:href="#error-block-image-disconnected-d" />
          </mask>
          <use fill="#FBBE47" fill-rule="nonzero" xlink:href="#error-block-image-disconnected-d" />
          <circle
            fill="#FFCD6B"
            fill-rule="nonzero"
      ...
      <g mask="url(#error-block-image-disconnected-b)" fill="#FBBE47" fill-rule="nonzero">
